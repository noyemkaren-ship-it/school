...
MCKO_QUESTIONS = {
    ...
    "russian_6_v1": {
        ...
        "variant": 1,
        "questions": [
            {"id": 1, "text": "В каком слове пишется буква 'е'?", "options": ["ц...на", "ц...рк", "ц...ган", "ц...пленок"], "answer": "цена"},
            ...
            {"id": 5, "text": "В каком слове пишется мягкий знак?", "options": ["ноч...", "врач...", "ключ...", "товарищ..."], "answer": "ночь"}
        ]
    },
    "chinese_6_v1": {
